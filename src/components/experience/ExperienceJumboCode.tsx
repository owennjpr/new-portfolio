    ...
    <div className="glassBorder p-4">
      <div className="blockText">
        ...
        <p className="text-sm sm:text-base text-center sm:text-start">
          ...
          English language skills. Creating a site for administrators and tutors
          to manage the organization's inventory of books and other student
          resources. Collaboratively working to complete tickets for bi-weekly
          sprints, adding new content and features to the site.
        </p>
