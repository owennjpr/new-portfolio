    ...
    <div className="glassBorder p-4">
      <div className="blockText">
        <div className="flex flex-col items-center sm:flex-row sm:items-baseline gap-1 sm:gap-4">
          ...
          <p className="">(Jun 2022 - Aug 2022)</p>
        </div>
        <p className="text-sm sm:text-base text-center sm:text-start">
          My first real job. I ran checkstands, bagged, and performed a variety
          of maintenance tasks at the Thriftway grocery store. I Maintained
          efficient and friendly service during hectic and high pressure
          periods.
        </p>
